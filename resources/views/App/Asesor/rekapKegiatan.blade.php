        ...
        <table id="listDosen" class="table table-striped table -bordered mt-2 text-center border-secondary-subtle align-middle" style="border: 2px;">
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="{{ route('rk-asesor-detail') }}"><button type="button" class="btn btn-primary mr-1">View Detail</button></a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>11S21008</td>
                    <td>S1 Informatika</td>
                    <td><button type="button" class="btn btn-primary mr-1" data-bs-toggle="modal" data-bs-target="#">View Detail</button></td>
                </tr>
