    ...
    <div class="row">
      <div class="col mr-2">
        ...
        <div class="input-group date">
          <input type="date" class="form-control date-input" id="tanggal-awal-evaluasi-diri" placeholder="dd/mm/yyyy">
          <div class="input-group-append">
            <button class="btn btn-outline-secondary clear-date" type="button" onclick="clearDate('tanggal-awal-evaluasi-diri')"><i class="fas fa-times"></i></button>
          </div>
        </div>
      </div>
      <div class="col">
        ...
        <div class="input-group date">
          <input type="date" class="form-control date-input" id="tanggal-akhir-evaluasi-diri" placeholder="dd/mm/yyyy">
          <div class="input-group-append">
            <button class="btn btn-outline-secondary clear-date" type="button" onclick="clearDate('tanggal-akhir-evaluasi-diri')"><i class="fas fa-times"></i></button>
          </div>
        </div>
      </div>
    </div>
