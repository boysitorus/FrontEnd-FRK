                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary mr-1" data-bs-toggle="modal"
                                        data-bs-target="#modalEditEvaluasiPenunjang-{{ $item['id_rencana'] }}">Tambah Lampiran
                                    </button>
                                </td>
                            </tr>
                            
                            {{-- TEMPAT MODAL ADD FILE A--}}
                            <div class="modal fade" id="modalEditEvaluasiPenunjang-{{ $item['id_rencana'] }}" tabindex="-1" aria-labelledby="modalEditEvaluasiPenunjangALabel"
                            aria-hidden="true">
                        ...
                        @if (isset($bimbingan) && sizeof($bimbingan))
                            ...
                            @foreach ($bimbingan as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary mr-1" data-bs-toggle="modal"
                                            data-bs-target="#modalEditEvaluasiPenunjangB-{{ $item['id_rencana'] }}">Tambah Lampiran
                                        </button>
                                    </td>
                                </tr>
