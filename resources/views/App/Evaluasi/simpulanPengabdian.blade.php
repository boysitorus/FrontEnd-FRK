@extends('Template.FEDsimpulanpengabdian')

@section('content-FEDsimpulanpengabdian')

<div id="simpulan-card" class="card border-primary mt-5 ml-1 mr-1">
    <div class="card-header bg-primary">
        <h6 style="color: white"><b>Lampiran Pelaksanaan Pengabdian</b></h6>
    </div>
    <div class="card-body">
        <div class="text-sm">
    ...
    <div class="col-md-6 ">
            ...
            <button class="btn btn-primary mt-3 justify-content-end mr-1" style="display:none"><i class="fas fa-save"></i> Simpan Permanen</button>
        </div>
