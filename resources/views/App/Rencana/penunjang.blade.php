                        ...
                        @if (isset($ukm) && sizeof($ukm) > 0)
                            ...
                            @foreach ($ukm as $item)
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <button type="button" class="btn btn-warning mr-1" data-bs-toggle="modal" data-bs-target="#modalEditPenunjang-{{ $item['id_rencana'] }}">
                                ...
                                {{-- MODAL EDIT --}}
                                <div class="modal fade" id="modalEditPenunjang-{{ $item['id_rencana'] }}" tabindex="-1" aria-labelledby="modalEditPenunjangCLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title" id="modalEditPenunjangCLabel">{{ $counter}}. {{ $item['nama_kegiatan'] }}</h6>
                                            ...
                                            <form action="{{ route('rk-penunjang.ukm.update') }}" method="POST">
                                                <div class="modal-body"> 
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="nama" name="nama_kegiatan" placeholder="{{ $item['nama_kegiatan'] }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="jumlah_kegiatan" class="form-label">Jumlah Kegiatan</label>
                                                        <input class="form-control" type="number" name="jumlah_kegiatan" placeholder="{{ $item['jumlah_kegiatan'] }}" min="1" step="any">
                                                    </div>
                                                </div>
                ...
                <tbody cllass="align-middle">
                    @if (isset($sosial) && sizeof ($sosial) > 0)
                        ...
                        @foreach ($sosial as $item)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning mr-1" 
                                        data-bs-toggle="modal" data-bs-target="#modalEditPenunjang-{{ $item['id_rencana'] }}">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <button type="button" class="btn btn-danger" 
                                        data-bs-toggle="modal" data-bs-target="#modalDeleteConfirm-{{ $item['id_rencana'] }}">
                            ...
                            {{-- MODAL EDIT --}} 
                            <div class="modal fade" id="modalEditPenunjang-{{ $item['id_rencana'] }}" tabindex="-1" aria-labelledby="modalEditPenunjangDLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modalEditPenunjangDLabel">{{ $counter++}}. {{ $item['nama_kegiatan'] }}</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form action = "{{ route('rk-penunjang.sosial.update') }}" method="POST">
                                            <div class="modal-body"> 
                                                ...
                                                <div class="mb-3">
                                                    <label for="nama_kegiatan" class="form-label">Nama Kegiatan</label>
                                                    <input type="text" class="form-control" name="nama_kegiatan" placeholder="{{ $item['nama_kegiatan']}}">
                                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{route('rk-penunjang.ukm.create')}}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="jumlah_kegiatan" class="form-label">Jumlah Kegiatan</label>
                                    <input class="form-control" type="number" name="jumlah_kegiatan" required min="1" step="any">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary">Simpan</button>
