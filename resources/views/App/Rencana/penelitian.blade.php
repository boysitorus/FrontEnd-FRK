...
<div class="card shadow-sm mt-5 ml-1 mr-1 bg-card">
    <div class="card-body">
        ...
        <div class = "row justify-content-end mr-0">
            <button id="btnFrkPenelitianB" type="button" class="btn btn-success col-md-auto mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#modalPenelitian_B">
                Tambah Kegiatan
            </button>
        </div>
...
<div class="card shadow-sm mt-5 ml-1 mr-1 bg-card">
    <div class="card-body">
        ...
        <div class="row justify-content-end mr-0">
            <button id="btnFrkPenelitianH" type="button" class="btn btn-success col-md-auto mt-2 mb-2">Tambah
                Kegiatan</button>
...
<div class="card shadow-sm mt-5 ml-1 mr-1 bg-card">
    <div class="card-body">
        <h5><b>M. Penyaji makalah dalam seminar atau pertemuan ilmiah terkait dengan bidang ilmu</b></h5>
        <hr />
...
<div class="card shadow-sm mt-5 ml-1 mr-1 bg-card">
    <div class="card-body">
        <h5><b>N. Reviewer jurnal ilmiah, proposal Hibah dll</b></h5>
        <hr />
...
<div class="card shadow-sm mt-5 ml-1 mr-1 mb-2 bg-card">
    <div class="card-body">
...
{{-- MULAI MODAL A --}}
<div class="modal fade modal-lg" id="modalEditPenelitian_A" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
        <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">A. Keterlibatan dalam 1 judul penelitian atau pembuatan karya seni atau teknologi yang dilakukan oleh kelompok (disetujui oleh pimpinan dan tercapai)</h6>
...
{{-- MULAI MODAL B --}}
<div class="modal fade modal-lg" id="modalEditPenelitian_B" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">B. Pelaksanaan penelitian mandiri atau pembuatan karya seni atau teknologi (disetujui oleh pimpinan dan tercatat)</h6>
