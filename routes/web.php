...
Route::group(['middleware' => ['check.token']], function() {
   ...
   Route::prefix('/formRencanaKerja')->group(function () {
       ...
       Route::get('/penelitian/buku_terbit', [PenelitianController::class, 'getBukuTerbit'])->name('rk-penelitian.buku_terbit');
       Route::post('/penelitian/buku_terbit-tambah', [PenelitianController::class, 'postBukuTerbit'])->name('rk-penelitian.buku_terbit.create');
       Route::delete('/penelitian/buku_terbit/{id}', [PenelitianController::class, 'deleteBukuTerbit'])->name('rk-penelitian.buku_terbit.destroy');
       Route::post('/penelitian/edit/buku_terbit', [PenelitianController::class, 'editBukuTerbit'])->name('rk-penelitian.buku_terbit.update');

       // route untuk data tabel d. buku internasional
       Route::get('/penelitian/buku_internasional', [PenelitianController::class, 'getBukuInternasional'])->name('rk-penelitian.buku_internasional');
       Route::post('/penelitian/buku_internasional-tambah', [PenelitianController::class, 'postBukuInternasional'])->name('rk-penelitian.buku_internasional.create');
       Route::delete('/penelitian/buku_internasional/{id}', [PenelitianController::class, 'deleteBukuInternasional'])->name('rk-penelitian.buku_internasional.destroy');
       Route::post('/penelitian/edit/buku_internasional', [PenelitianController::class, 'editBukuInternasional'])->name('rk-penelitian.buku_internasional.update');
