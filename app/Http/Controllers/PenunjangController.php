...
class PenunjangController extends Controller
{
    ...
    {
        Http::post('http://localhost:9000/api/penunjang/ukm',
            [
    ...
    {
        Http::post("http://localhost:9000/api/penunjang/edit/ukm",
            [
    ...
    {
        Http::post('http://localhost:9000/api/penunjang/sosial',
        [
            'id_dosen' => $request->get('id_dosen'),
            'nama_kegiatan' => $request->get('nama_kegiatan'),
        ]);
    ...
    {
        Http::post("http://localhost:9000/api/penunjang/edit/sosial",
        [
            'id_rencana' => $request->get('id_rencana'),
            'nama_kegiatan' => $request->get('nama_kegiatan'),
        ]);
